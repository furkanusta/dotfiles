(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-web beacon doom-modeline company-lsp lsp-ui cquery magit-todos company-flx company-quickhelp ace-jump-buffer helm-bm persp-mode eyebrowse bm elfeed fzf readline-complete interleave benchmark-init org-noter orgit org-ref graphviz-dot-mode flycheck-pycheckers darkokai-theme srefactor quickrun helm-pydoc pydoc company-anaconda auto-virtualenvwrapper virtualenvwrapper scala-mode docker-tramp dockerfile-mode docker-compose-mode helm-flycheck helm-ag helm-tramp helm-projectile helm-swoop spaceline-all-the-icons all-the-icons init-programming-languages init-others init-helm uniquify init-defaults init-bindings c++-mode shell-mode fci persp hs-minor-mode helm-semantic diff-hl-dired-mode diff-hl-mode writegood dired fill-column-indicator persp-projectile perspective restart-emacs writegood-mode projectile ibuffer-vc helm-rtags flycheck-rtags company-rtags rtags company-c-headers use-package focus cmake-font-lock ace-window buffer-move diff-hl company-irony-c-headers flycheck-irony pydoc-info terminal-here pdf-tools color-theme-buffer-local magit markdown-mode+ web-mode gist helm-gitignore gitignore-mode tuareg dylan-mode fsharp-mode guile-scheme helm-flyspell ensime vlf modern-cpp-font-lock anaconda-mode peep-dired diminish org-journal company-irony cmake-ide company irony yaml-mode sr-speedbar org-cliplink org-download visual-fill-column writeroom-mode org-bullets immortal-scratch f3 powerline swiper swiper-helm highlight-symbol visual-regexp-steroids ag drag-stuff hideshow-org indent-guide evil-nerd-commenter undo-tree helm-c-yasnippet flycheck yasnippet monokai-theme)))
